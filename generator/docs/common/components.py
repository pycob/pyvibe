...
navbar.add_navbarlink("Tutorial", "tutorial.html")
...
with footer.add_footercategory("About") as category:
    category.add_footerlink("PyVibe Home", "https://www.pyvibe.com")
...
with footer.add_footercategory("Learn") as category:
    category.add_footerlink("Interactive Tutorial", "tutorial.html")
