import pyvibe as pv
from .common.components import footer, marketing_banner

page = pv.Page("Hero", navbar=None, footer=footer, image="./img/social.png")

container_outer = page.add_container(grid_columns=2)

container_inner1 = container_outer.add_container()
container_inner1.add_header("<span class='gradient-text'>PyVibe</span>", size=9)
container_inner1.add_image("https://cdn.pycob.com/pyvibe.svg", 'logo', classes='w-1/2')
